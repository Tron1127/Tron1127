...
- ICA-based artifact removal and ICLabel workflows
- Auditory and visual EEG experimental paradigms
- SSVEP / oddball / attention-related EEG analysis
- Deep learning models for EEG classification

### 🕶️ VR / AR / XR Rehabilitation
- VR-based upper-limb rehabilitation training systems
- AR home-based and center-based rehabilitation systems
- Pain management and motor recovery applications
...
- GitHub: [GitHub/Tron1127](https://github.com/Tron1127)
